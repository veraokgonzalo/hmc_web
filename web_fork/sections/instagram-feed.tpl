...
{% set data_store_value = claim_legacy_data_store('home-instagram-feed') ? 'home-instagram-feed' : section.id %}
...
<div
	class="js-instagram-feed {% if full_width %}section-full-width{% endif %}"
...
{% schema %}
{
  "name": "t:names.instagram_feed",
  "icon": "InstagramIcon",
  "class": "section section-instafeed-home",
  "limit": 1,
  "blocks": [
    { "tags": ["general"] }
  ],
      ...
      "blocks": [
        {
          "type": "heading",
          "settings": {
            "title": "t:defaults.instagram_feed",
            "size": "h4"
          }
        },
        {
