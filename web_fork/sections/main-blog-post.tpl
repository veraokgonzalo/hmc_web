{#
  Blog Post Section
  Single blog post content with image, date, and body.
#}
...
>
	...
	{% endif %}
		<div class="blog-post-page">
			{% include 'snippets/blog/blog-post-content.tpl' %}
		</div>
	{% if page_width %}
		</div>
	{% endif %}
...
{% schema %}
{
  "name": "t:names.blog_post_content",
  "class": "section section-main-blog-post",
  "static": true,
  "limit": 1,
  "presets": [{"name": "t:names.blog_post_content"}],
  "settings": [
    {
      "type": "header",
