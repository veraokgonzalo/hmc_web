{% embed "snipplets/modal.tpl" with{modal_id: 'home-modal', modal_class: 'home-promotional modal-bottom-sheet modal-shadow', modal_position: 'bottom', modal_transition: 'slide', modal_header_title: true, modal_footer: false, modal_width: 'docked-md modal-docked-small modal-docked-md-right', modal_body_class: 'p-0' } %}
    ...
    {% block modal_body %}
        ...
        {% if settings.home_news_box %}
            <div id="news-popup-form-container" class="newsletter px-3 pb-3">
                <form id="news-popup-form" method="post" action="/winnie-pooh" class="js-news-form" data-store="newsletter-form-popup">
                    <div class="newsletter-form input-append row no-gutters">
                        ...
                        <div class="col-auto pl-2">
                            ...
                            <input type="submit" name="contact" class="js-news-popup-submit btn btn-primary" value="{{ "Enviar" | translate }}" />
