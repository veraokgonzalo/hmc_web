# 🗺️ Mapa de Recursos e Imágenes - HMC HUB

Guía de referencia de archivos de imagen y recursos multimedia del proyecto `boceto_web/`. Cada archivo cuenta con un nombre semántico que identifica inmediatamente su función y ubicación en la tienda.

---

## 1. Categorías Destacadas (`assets/images/categories/`)
...
## 2. Hero Slider, Banners y Popups (`assets/images/hero/`)
...
## 3. Catálogo de Productos y Fichas Técnicas (`assets/images/products/`)
...
## 4. Logotipos Institucionales (`assets/logos/`)

| Archivo | Ubicación en la Web | Uso / Especificación |
|---|---|---|
| `logo-horizontal-color.png` | Cabecera principal (todas las páginas) | Logo oficial a color sobre fondo blanco |
| `logo-horizontal-white.png` | Drawer móvil, Top bar y Footers oscuros | Logo oficial en blanco sobre fondos oscuros |
| `logo-circular-green.png` | Hero Slide 2 y Sellos de Garantía | Isotipo circular verde oficial |
| `logo-circular-dark.png` | Hero Slide 3 / Servicio Técnico | Variante circular monocroma oscura |
| `logo-circular-badge.png` | Hero Slide 1 / Ofertas | Sello insignia circular |

---

## 5. Videos (`assets/videos/`)
