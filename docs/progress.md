...
- **Portadas y Categorías de Portada Actualizadas**: Se crearon y mapearon las 6 portadas de categorías en `boceto_web/assets/images/categories/` (`categoria-1-ferreteria.jpg`, `categoria-2-maquinas-explosion.jpg`, `categoria-3-agua-bombeo.jpg`, `categoria-4-construccion.jpg`, `categoria-5-herramientas-bateria.jpg`, `categoria-6-accesorios-insumos.jpg`).
